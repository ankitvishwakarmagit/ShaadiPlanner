  ...
  useEffect(() => {
    const loadCard = async () => {
      try {
        ...
        setCard(data)
        document.title = `${data.name} - Card Details | ShaadiPlanner`
      } catch (err) {
        ...
        <div className="dp-section dp-section-1" id="dp-section-details">
          ...
          <div className="dp-subsection-2">
            ...
            <div className="dp-price-buttons">
              ...
              <div className="dp-price-range">{card.pricePerCard.toLocaleString()} INR</div>
            </div>
          </div>
        </div>
        ...
        <div className="dp-section" id="dp-section-pricing">
          ...
          <div className="dp-package-details">
            <div className="dp-inclusions-section">
              <h4>Pricing</h4>
              <div className="dp-package-price">{card.pricePerCard.toLocaleString()} INR per card</div>
          ...
          <div className="dp-reviews-list">
            {displayedReviews.map((review, idx) => (
              <div key={idx} className="dp-review-item">
                <div className="dp-stars">{"â˜…".repeat(review.stars)}</div>
                <p>
