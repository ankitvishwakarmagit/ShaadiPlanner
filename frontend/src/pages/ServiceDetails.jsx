  ...
  useEffect(() => {
    const loadService = async () => {
      try {
        ...
        setService(data);
        document.title = `${data.name} - Service Details | ShaadiPlanner`;
      } catch (err) {
        ...
        <div className="dp-section dp-section-1" id="dp-section-details">
          ...
          <div className="dp-subsection-2">
            ...
            <div className="dp-price-buttons">
              ...
              <div className="dp-price-range">{service.priceRange} INR</div>
            </div>
          </div>
        </div>
              ...
              {service.pricingPackages.map((pkg, idx) => (
                ...
                >
                  <div className="dp-inclusions-section">
                    ...
                    <div className="dp-package-price">{pkg.price.toLocaleString()} INR</div>
