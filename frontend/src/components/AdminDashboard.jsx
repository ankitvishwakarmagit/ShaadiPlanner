                      ...
                      {selectedService.pricing_packages.map((pkg, index) => (
                        <div className="col-md-4 mb-3" key={index}>
                          <div className="package-card p-3 border rounded">
                            ...
                            <p className="package-price mb-2"><i className="fas fa-money-bill-wave me-1"></i> INR {pkg.price.toLocaleString()}</p>
                            {pkg.inclusions && (
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <p><strong><i className="fas fa-money-bill-alt me-2"></i>Price per Card:</strong> INR {selectedCard.price ? selectedCard.price.toLocaleString() : selectedCard.price_per_card?.toLocaleString()}</p>
                    </div>
                    <div className="col-md-6">
              ...
              <div className="alert alert-info">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      This vendor has applied to offer {selectedVendor.category} services on the ShaadiPlanner platform.
