...
const userSchema = new mongoose.Schema(
  {
    ...
    vendorRequest: {
      ...
      phone_whatsapp: { type: String, match: [/^\+91[6-9]\d{9}$/, "Must be a valid 10-digit Indian mobile number with +91"] },
      whatsapp_number: { type: String, match: [/^\+91[6-9]\d{9}$/, "Must be a valid 10-digit Indian mobile number with +91"] },
      category: {
        type: String,
        enum: [
          "Wedding Venues",
